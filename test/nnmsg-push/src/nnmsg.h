#ifndef NNMSG_PUSH_NNMSG_H
#define NNMSG_PUSH_NNMSG_H
...
static void nnmsg_close_impl (string file, int line, int sock);
...
static void NN_UNUSED nnmsg_close_impl (string file, int line, int sock)
{
    int rc;
